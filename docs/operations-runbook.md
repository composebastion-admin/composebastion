...
- For a 1.0.6, 1.1.2, 1.1.3, or 1.1.4 manager, schedule two distinct jobs: first target 1.1.5
...
- The current compatibility app and agent tags are `1.1.5` and `v1.1.5`.
  Verify that bridge before the 1.2 transition.
