...
| `1.1.3` or `v1.1.3` | Compatibility bridge pin for the qualified 1.2 transition. |
...
Installations on 1.0.6 or 1.1.2 must update to 1.1.3 first. Once 1.1.3 is
...
- `v1.1.3` is the compatibility-only V1 bridge release for this repository.
