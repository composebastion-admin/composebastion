...
<p align="center">
  <a href="https://github.com/composebastion-admin/composebastion/releases"><img alt="Release" src="https://img.shields.io/badge/release-v1.1.4-e0a23f"></a>
...
- Package and OpenAPI version: `1.1.4`.
- GitHub release images: `1.1.4` and `v1.1.4`.
...
| `1.1.4` or `v1.1.4` | Compatibility bridge pin for the qualified 1.2 transition. |
...
then promote them to version tags such as `1.1.4` and `v1.1.4`, the minor tag,
...
Installations on 1.0.6, 1.1.2, or 1.1.3 must update to 1.1.4 first. Once 1.1.4 is
...
- `v1.1.4` is the compatibility-only V1 bridge qualified for the 1.2 transition;
  the immutable `v1.1.3` release remains available for historical recovery.
