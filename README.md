...
<p align="center">
  <a href="https://github.com/composebastion-admin/composebastion/releases"><img alt="Release" src="https://img.shields.io/badge/release-v1.1.5-e0a23f"></a>
...
- Package and OpenAPI version: `1.1.5`.
- GitHub release images: `1.1.5` and `v1.1.5`.
...
| `1.1.5` or `v1.1.5` | Compatibility bridge pin for the qualified 1.2 transition. |
...
then promote them to version tags such as `1.1.5` and `v1.1.5`, the minor tag,
...
Installations on 1.0.6, 1.1.2, 1.1.3, or 1.1.4 must update to 1.1.5 first. Once 1.1.5 is
healthy, use its updater for the 1.2 transition; direct pre-1.2-to-1.2 updates
are not release-qualified. During the bridge rollout, `latest` remains on
1.1.5.
...
- `v1.1.5` is the compatibility-only V1 bridge qualified for the 1.2 transition;
  the immutable `v1.1.3` and `v1.1.4` releases remain available for historical
  recovery.
