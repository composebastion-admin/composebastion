...
- Always bump the project version for pushed changes unless the user explicitly
  says the work is no-release/unreleased. Patch bumps are the default for fixes,
  CI hardening, docs, and small features.
